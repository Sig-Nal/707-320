...
var alternator2 = Alternator.new(0,"controls/electric/engine[2]/generator","/engines/engine[2]/rpm",20.0,28.0,60.0);
var alternator3 = Alternator.new(1,"controls/electric/engine[3]/generator","/engines/engine[3]/rpm",20.0,28.0,60.0);
#####################################
...
var init_switches = func{
    ...
    append(lbus_load,1);
    append(lbus_input,AVswitch);
    append(lbus_output,props.globals.initNode("systems/electrical/outputs/nav[0]",0,"DOUBLE"));
    append(lbus_load,1);
    append(lbus_input,AVswitch);
